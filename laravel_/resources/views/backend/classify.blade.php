					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form id="form-wizard" class="form-horizontal" action="classify_add" method="post" />
									<div id="form-wizard-1" class="step">
										<div class="control-group">
											<label class="control-label">企业类别</label>
											<div class="controls">
												<input id="username" type="text" name="classify"  />
											</div>
                                            ...
                                            <div class="controls">
                                                <select name="pid" id="">
                                                    ...
                                                    @foreach($data as $key => $sort)
                                                        ...
                                                        <option value="{{ $sort -> id }}">{{ $sort -> classify }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
