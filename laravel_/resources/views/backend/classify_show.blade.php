...
@section('content')
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered data-table" align="center">
							...
							<tr class="gradeX">
                                ...
                                @endif
								<td>
								<a class="btn btn-danger" href="classify_save/{{ $sort -> id }}" role="button">Save</a>
								<a class="btn btn-warning" href="classify_del/{{ $sort -> id }}" role="button">Delete</a>
								<a class="btn btn-warning" href="classify_recycle/{{ $sort -> id }}" role="button">recycle_bin</a>
								</td>
							</tr>
							@endforeach
        ...
        <script>
            ...
            $('.is_show').blur(function(){
                ...
                /*  目前不知道怎么传 所以 写的绝对路径 */
                $.ajax({
                url:'http://192.168.1.45/laravel/laravel_/public/classify_gai/'+num+'/'+ids,
                type:'get',
