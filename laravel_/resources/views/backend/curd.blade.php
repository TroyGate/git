					...
					<div class="span12">
						<div class="widget-box">
							<div class="widget-title">
								...
								<h3>CURD 一键生成 数据库的操作</h3>
							</div>
							<div class="widget-content nopadding">
								<form action="{{URL::asset('controller_model')}}" method="post" class="form-horizontal" enctype="multipart/form-data" />
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">model名称 (数据库)</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">controller 路径)</label>
                                        <div class="controls">
                                            <input type="text" name="controller_url"/>
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label">model路径</label>
                                        <div class="controls">
