					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="{{URL::asset('job_saves')}}" method="post" class="form-horizontal" enctype="multipart/form-data" />
									<div class="control-group">
										<label class="control-label">公司名称</label>
										<div class="controls">
											<input type="text" name="job_name" value="{{$result['job_name']}}"/>
										</div>
									</div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="tel" value="{{$result['job_name']}}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="site" value="{{$result['site']}}"/>
                                        </div>
                                    </div>
