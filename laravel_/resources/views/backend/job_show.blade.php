					...
					<div class="widget-content nopadding">
						<table class="table table-bordered data-table" align="center">
							...
							<tr class="gradeX">
                                ...
                                <td>{{ $sort -> site }}</td>
								<td>
								<a class="btn btn-danger" href="job_save/{{ $sort -> id }}" role="button">Save</a>
								<a class="btn btn-warning" href="job_del/{{ $sort -> id }}" role="button">Delete</a>
								</td>
							</tr>
							@endforeach
							</tbody>
...
//            $('document').on('blur', '.is_show', function(){
//                alert(1)
//            })
