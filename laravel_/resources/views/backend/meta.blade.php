					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="{{URL::asset('meta_add')}}" method="post" class="form-horizontal" enctype="multipart/form-data" />

                                    <div class="control-group">
                                        <label class="control-label">{{$name}} 属性</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">标注内容</label>
                                        <div class="controls">
