	...
	<body>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="submenu">
					<a href="#"><i class="icon icon-file"></i> <span>相册页面</span> <span class="label">4</span></a>
					<ul>
						<li><a href="invoice.html">清单</a></li>
						<li><a href="photo_ide">相册编辑</a></li>
						<li><a href="photo_add">相册添加</a></li>
						<li><a href="photo_album">相册</a></li>
					</ul>
				</li>
				<li>
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="alert alert-info">
							欢迎来到<strong>相册后台管理系统</strong>. 别忘记退出哦!
