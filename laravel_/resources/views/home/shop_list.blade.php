...
<script type="text/javascript" src="js/lib/iscroll/iscroll-probe.js"></script>
<script type="text/javascript" src="js/lib/amazeui/amazeui.min.js"></script>
<script type="text/javascript" src="js/lib/raty/jquery.raty.js"></script>
                ...
                <div class="case-list">
                    <div class="am-u-sm-6 am-u-md-4 am-u-lg-3">
                        <div class="case-list-item">
                            <a href="./case_info.html"><img src="img/cast_list_01.jpg" /><span>商务型自选模版</span></a>
                        </div>
                    </div>
                    <div class="am-u-sm-6 am-u-md-4 am-u-lg-3">
                        <div class="case-list-item">
